...
var factorial = function(n) {
	...
	// base case: return 1 for the last number 
	if (n === 0) {
		return 1;
	}

	// recursion: call factorial until 1 is reached
...
var sum = function(array) {
	// base case: if the array is empty, no more to add up
	if (array.length === 0) {
		return 0;
	}

	// recursion: hold the first element of the array, slice input array without initial element until empty
...
var arraySum = function(array) {
	...
	// base case: if the inputted array is empty, return 0
	if (array.length === 0) {
		return 0;
	}

	// add initial value, input the flattened array into the recursion
...
var range = function(x, y) {
	...
	// return array with x and recursed range with x + 1
	return [x].splice(1,0,(range(x,y)));
};
